...
variable "LAMBDA_GET_MNO_THIRD_PARTY_RESOURCE_BY_ID_INVOKE_ARN" {}
variable "GET_MNO_THIRD_PARTY_RESOURCE_BY_ID_LAMBDA_NAME" {}
variable "LAMBDA_GET_MNO_RESOURCE_BY_TYPE_INVOKE_ARN" {}
variable "GET_MNO_RESOURCE_BY_TYPE_LAMBDA_NAME" {}

variable "LAMBDA_GET_THIRD_PARTY_RESOURCE_BY_TYPE_INVOKE_ARN" {}
variable "GET_THIRD_PARTY_RESOURCE_BY_TYPE_LAMBDA_NAME" {}



variable "LAMBDA_GET_THIRD_PARTY_RESOURCES_USERS_ACCOUNTS_INVOKE_ARN"{}
variable "GET_THIRD_PARTY_RESOURCES_USERS_ACCOUNTS_LAMBDA_NAME" {}

variable "LAMBDA_GET_MNO_RESOURCES_USERS_ACCOUNTS_INVOKE_ARN"{}
variable "GET_MNO_RESOURCES_USERS_ACCOUNTS_LAMBDA_NAME" {}



variable "LAMBDA_GET_MNO_USER_BY_ID_INVOKE_ARN"{}
variable "GET_MNO_USER_BY_ID_LAMBDA_NAME" {}

variable "LAMBDA_GET_THIRD_PARTY_USER_BY_ID_INVOKE_ARN"{}
variable "GET_THIRD_PARTY_USER_BY_ID_LAMBDA_NAME" {}

variable "CREATE_MNO_RESOURCE_USER_LAMBDA_NAME" {}
variable "LAMBDA_CREATE_MNO_RESOURCE_USER_INVOKE_ARN" {}

variable "CREATE_THIRD_PARTY_RESOURCE_USER_LAMBDA_NAME" {}
variable "LAMBDA_THIRD_PARTY_RESOURCE_USER_INVOKE_ARN" {}

variable "DELETE_MNO_RESOURCE_USER_LAMBDA_NAME" {}
variable "LAMBDA_DELETE_MNO_RESOURCE_USER_INVOKE_ARN" {}

variable "DELETE_THIRD_PARTY_RESOURCE_USER_LAMBDA_NAME" {}
variable "LAMBDA_DELETE_THIRD_PARTY_RESOURCE_USER_INVOKE_ARN" {}
...
variable "LAMBDA_UPDATE_USER_ACCOUNT_INVOKE_ARN" {}
variable "UPDATE_USER_ACCOUNT_LAMBDA_NAME" {}
variable "LAMBDA_UPDATE_PERMISION_FOR_API_INVOKE_ARN" {}
variable "UPDATE_PERMISION_FOR_API_LAMBDA_NAME" {}
variable "LAMBDA_GET_ALL_APIS_FOR_RESOURCE_INVOKE_ARN"{}
variable "GET_ALL_APIS_FOR_RESOURCE_LAMBDA_NAME"{}
variable "GET_SPECIFIC_USER_DETAILS_LAMBDA_NAME" {}
variable "LAMBDA_GET_SPECIFIC_USER_DETAILS_INVOKE_ARN"{}