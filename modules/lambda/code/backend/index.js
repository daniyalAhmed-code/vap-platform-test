...
app.put('/admin/accounts/:userId', wrapError(require('./routes/admin/accounts').put))
...
app.get('/admin/accounts/generateApiKey/:userId', wrapError(require('./routes/admin/accounts').generate_new_api_key))
app.post('/admin/accounts/profileImage/:userId',  wrapError(require('./routes/admin/accounts').update_profile_image))
app.get('/admin/accounts/profileImage/:userId',  wrapError(require('./routes/admin/accounts').get_profile_image))
