...
module "api" {
  ...
  GET_SPECIFIC_USER_DETAILS_LAMBDA_NAME     = module.lambda.GET_SPECIFIC_USER_DETAILS_LAMBDA_NAME
  LAMBDA_GET_SPECIFIC_USER_DETAILS_INVOKE_ARN = module.lambda.LAMBDA_GET_SPECIFIC_USER_DETAILS_INVOKE_ARN
