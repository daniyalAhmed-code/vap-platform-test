...
module "api" {
  ...
  LAMBDA_GENERATE_NEW_API_KEY_INVOKE_ARN        = module.lambda.LAMBDA_GENERATE_NEW_API_KEY_INVOKE_ARN
  GENERATE_NEW_API_KEY_LAMBDA_NAME            = module.lambda.GENERATE_NEW_API_KEY_LAMBDA_NAME
